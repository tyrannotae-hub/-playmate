  ...
  return (
    <div className={cardClass()}>
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            <span
              className={`btn-label inline-flex items-center rounded-sm px-1.5 py-0.5 text-[10px] font-bold ${
      ...
      {booking.changeRequestedAt && (
        <div className="mt-3 rounded-sm border border-energy bg-energy-soft px-3 py-2.5">
      ...
      {booking.cancelRequestedAt && (
        <div className="mt-3 rounded-sm border border-negative bg-negative/5 px-3 py-2.5">
