      ...
      >
            ...
            {ITEMS.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  onClick={onClose}
                  className={`btn-label rounded-sm px-3 py-2.5 text-sm font-bold transition ${
                    active
        ...
        <div className="border-t border-line px-2 py-3">
          <button
            ...
            className="btn-label block w-full rounded-sm px-3 py-2.5 text-left text-sm font-bold text-muted transition hover:bg-rink-soft"
          >
            로그아웃
          </button>
        </div>
