      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto px-2 py-3">
          <Link
            href="/search"
            onClick={onClose}
            className="btn-label block rounded-sm px-3 py-2.5 text-sm font-bold text-rink-deep transition hover:bg-rink-soft"
          >
            전체 종목 보기
          </Link>
              ...
              <div className="mt-1 flex flex-col">
                {list.map((s) => (
                  <Link
                    ...
                    onClick={onClose}
                    className="flex items-center gap-2.5 rounded-sm px-3 py-2.5 text-sm font-semibold transition hover:bg-rink-soft"
                  >
