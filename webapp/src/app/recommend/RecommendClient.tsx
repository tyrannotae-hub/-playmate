        ...
        <main className="px-4 pb-10 pt-4">
          ...
          {top && (
            <Link
              ...
              className="block rounded-sm border-2 border-rink bg-rink-soft p-5 transition hover:opacity-90"
            >
          ...
          {current.options.map((option) => {
            ...
            return (
              <button
                ...
                className={`rounded-sm border px-4 py-3.5 text-left text-sm font-semibold transition ${
                  active
