      ...
      <main className="pb-10 pt-3">
        ...
        <div className="mb-4 flex gap-2 px-4">
          <select
            ...
            className="flex-1 rounded-sm border border-line bg-surface px-3 py-2 text-sm font-semibold"
          >
          ...
          <select
            ...
            className="rounded-sm border border-line bg-surface px-3 py-2 text-sm font-semibold"
          >
