    ...
    <>
      ...
      <main className="px-4 pb-10 pt-4">
        ...
        <input
          ...
          className="mt-4 w-full rounded-sm border border-line bg-surface p-3.5 text-sm"
        />
        ...
        <textarea
          ...
          className="mt-3 w-full rounded-sm border border-line bg-surface p-3.5 text-sm"
          rows={5}
        />
          ...
          <div className="mt-3 grid grid-cols-4 gap-2">
            {photos.map((photo, i) => (
              <div key={photo.previewUrl} className="relative aspect-square">
                <div
                  className="h-full w-full rounded-sm border border-line bg-surface-2 bg-cover bg-center"
            ...
            {photos.length < MAX_PHOTOS && (
              <label
                ...
                className="flex aspect-square cursor-pointer flex-col items-center justify-center rounded-sm border border-dashed border-line text-xs text-muted"
              >
