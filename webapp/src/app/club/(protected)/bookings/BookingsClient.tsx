...
function BookingsClientInner({ bookings }: { bookings: ClubBooking[] }) {
  ...
  return (
    <>
      ...
      <div className="mt-2 flex flex-wrap gap-1.5">
        {TYPE_TABS.map((t) => (
          <button
            ...
            className={`h-8 flex-shrink-0 rounded-sm px-3 text-xs font-bold transition ${
      ...
      {classId && (
        <div className="mt-3 flex items-center justify-between rounded-sm border border-line bg-surface-2 px-3 py-2">
